...
@AllArgsConstructor
@Getter
public enum ApplicationStatusBackup5 {
    ...
    FIRST_MEETING_CREATED(31 , "First Meeting create by Application manager"), //done

    FIRST_MEETING_DOC_UPLOADED(32 , "First Meeting completed and documents uploaded"), //done

    FIRST_MEETING_REPORT_UPLOADED(33, "First meeting report, question and evidence uploaded"),

    SECOND_MEETING_CREATED(301 , "Second Meeting create by Application manager"), //done

    SECOND_MEETING_REPORT_UPLOADED(303, "Second meeting report, question and evidence uploaded"),
    ...
    AM_UPLOAD_AGENDA_FORM(41 , "AM or ILEP upload the agenda form"),

    SITE_VISIT_AM_CHANGE_THE_SITE_VISIT_DATE(42 , "Meeting completed and Mom uploaded - AM changes the site visit date"), //done

    INSTITUTION_UPDATES_AGENDA_FORM(42 , "Institution updates the agenda form with comments "), //done

    AM_REJECT_SITE_VISIT_DOCUMENT(43,"Am reject the site visit document with comments"),
    ...
    AM_REJECTED_THE_DOCUMENT(61, "Am reject application on document update"),
    ...
    public static ApplicationStatusBackup5 getByCode(Integer code) {
        for (ApplicationStatusBackup5 applicationStatus : values()) {
