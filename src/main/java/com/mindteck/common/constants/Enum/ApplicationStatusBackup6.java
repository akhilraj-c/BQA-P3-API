...
@AllArgsConstructor
@Getter
public enum ApplicationStatusBackup6 {
    ...
    APPLIED_FOR_ARCHIVAL(215,"Applied for Archival"),
    ARCHIVAL_APPROVED(216,"Archival Approved"),
    ARCHIVAL_REJECTED(217,"Archival Rejected"),

    INSTITUTION_CLOSED(220,"Closed"),
    INSTITUTION_WITHDRAWN(223,"Withdrawn"),
    ...
    public static ApplicationStatusBackup6 getByCode(Integer code) {
        for (ApplicationStatusBackup6 applicationStatus : values()) {
