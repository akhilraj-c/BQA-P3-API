...
public enum ApplicationStatus {
    ...
    ADMINISTRATIVE_CHECk_COMPLETED(11 , "AM completed Administrative Check and Verification Process with complete status"), //done
    REQUIRED_ADDITION_DATA(12 , "Required additional data or Incomplete"), //done

    //new Status for timeline
    VERIFICATION_CHECk_COMPLETED(2000 , "AM Submitted Verification process with complete status"), //done

    INSTITUTION_ADMIN_CHECK_RESUBMIT(2001,"Institution Re-Submitted additional data for Administrative Check"),

    INSTITUTION_VERIFICATION_RESUBMIT(2002,"Institution Re-Submitted additional data for Verification Process"),

    ADMIN_CHECK_COMPLETED(2003 , "AM Submitted Administrative Check with complete status"),

    REQUIRED_ADDITION_DATA_ADMIN_CHECK(2004 , "Required additional data for Administrative Check"),

    VERIFICATION_REQUIRED_ADDITION_DATA(2005 , "Required additional data for Verification Process"),
    ...
    ILEP_EVALUATE_LISTED(74, "Ilep member evaluation met / Valid"), //done
    ILEP_EVALUATE_DEFERRED(75 , "ILEP members  evaluation partially met / deferred "), //done

    ILEP_EVALUATE_NOT_LISTED(76 , "ILEP members  evaluation not met / not Valid "), //done
    ...
    REVALIDATION_AM_VALIDATION_TO_BE_SUBMITTED(120, "For revalidation waiting for AM validation report"), //done
    ...
    ILEP_UPDATE_THE_EVALUATION_AS_LISTED_OR_NOTLISTED(160,"ILEP updated the evaluation report as Valid/Not Valid"),
    ...
    AM_FACTUAL_ACCURACY_WITH_NOT_LISTED(180,"Factual accuracy started with Not Valid (The AM/DFO Admin send the report along with profiles for factual accuracy)"), //done

    AM_FACTUAL_ACCURACY_WITH_LISTED(181,"Factual accuracy started with  Valid (The AM/DFO Admin send the report along with profiles for factual accuracy)"), //done

    INSTITUTION_COMMENTS_ADDED(182 , "Institution commented for factual accuracy Valid/not Valid  (Institue reports factual error or no error)"), //done

    AM_FACTUAL_ACCURACY_COMPLETED_WITH_LISTED(183, "Factual accuracy completed,  Valid (AM/DFO admin updated the factual accuracy and factual accuracy completed)"), //done

    AM_FACTUAL_ACCURACY_COMPLETED_WITH_NOT_LISTED(184, "Factual accuracy completed,  Not Valid (AM/DFO admin updated the factual accuracy and factual accuracy completed)"), //done
    ...
    DFO_ADMIN_APPROVE_AS_CABINET_APPROVE(206,"DFO Admin will update as Cabinet Approved- and share a copy to Institution as a status as Valid"),
    ...
    INST_DATE_EXT_REQ_CONDI_FULL(1017, "Institution requested date extension for condition fulfilment"),

    DATE_EXT_APPROVED_CONDI_FULL(1018,"Date extension request  for condition fulfilment approved"),

    DATE_EXT_REJECTED_CONDI_FULL(1019,"Date extension request for  condition fulfilment rejected"),


    /**---------------------------------------------keeping 11 status for future--------------------------------------------------------------*/

    ILEP_PANEL_CREATED_SEP(1028 , "AM assign the application with proposed ILEP Panel "), //done

    AM_APPROVED_ILEP_PANEL_SEP(1029, "Application manager created Evaluation Panel -AM approved the Evaluation Panel"), //need to remove
    INSTITUTION_ILEP_PANEL_NON_CONFLICT_SEP(1030 , "Institute declare no-conflict "), //done

    INSTITUTION_ILEP_PANEL_CONFLICT_SEP(1031 , "Application manager created ilep panel - Institution user signed the conflict against Evaluation Panel -0/3 "), //done

    INSTITUTION_ILEP_PANEL_CONFLICT_AM_APPROVE_SEP(1032 , "AM approve the ilep conflict raised by institution"), //done

    INSTITUTION_ILEP_PANEL_CONFLICT_DFO_APPROVE_SEP(1033 , "DFO approve the ilep conflict raised by institution after AM approve"), //done

    ILEP_PANEL_USER_1_INSTITUTION_CONFLICT_SEP(1034, "Ilep user 1 conflict"), //done
    ILEP_PANEL_USER_1_INSTITUTION_NON_CONFLICT_SEP(1035, "Ilep user 1 non-conflict"), //done

    ILEP_PANEL_USER_2_INSTITUTION_CONFLICT_SEP(1036, "Ilep user 2 conflict"), //done
    ILEP_PANEL_USER_2_INSTITUTION_NON_CONFLICT_SEP(1037, "Ilep user 2 non-conflict"), //done

    ILEP_PANEL_USER_3_INSTITUTION_CONFLICT_SEP(1038, "Ilep user 3 conflict"), //done
    ILEP_PANEL_USER_3_INSTITUTION_NON_CONFLICT_SEP(1039, "Ilep user 3 non-conflict"), //done

    ILEP_PANEL_ASSIGNED_SEP(1040 , "Ilep panel assigned"), //done



    ACCESS_GRANT_ILEP_1_SEP(1041 , "Grant Access Ilep 1"), //done
    ACCESS_GRANT_ILEP_2_SEP(1042 , "Grant Access  Ilep 2"), //done
    ACCESS_GRANT_ILEP_3_SEP(1043 , "Grant Access  Ilep 3"), //don
