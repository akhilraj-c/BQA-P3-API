...
@AllArgsConstructor
@Getter
public enum ApplicationStatusNew {
    ...
    FAILED_TO_SUBMIT(7 , "Institution failed to submit the application on time"), //need to implement
    ...
    ADMINISTRATIVE_CHECk_COMPLETED(11 , "Administrative check completed - Administrative check completed"), //done
    REQUIRED_ADDITION_DATA(12 , "Incomplete"), //done

    PROCEED_WITH_INCOMPLETE_STATUS(13,"Admin Check(Sent)"),
    APPLICATION_MANAGER_REJECTED(14 , "Application manager rejected the application"),

    APPLICATION_MANAGER_ACKNOWLEDGEMENT(15 , "Application Acknowledgement"),  //need to implementy

    INSTITUTION_RESUBMITTED_DOCUMENT_FOR_ADMINISTRATIVE_CHECK(16, "Application manager requested for additional data : Inst. user re-submitted the documents for administrative check"), //done

    ILEP_PANEL_CREATED(17 , "Application manager created Evaluation Panel- AM assigned Evaluation Panel and submitted for Director approval "), //done

    DIRECTOR_APPROVED_ILEP_PANEL(18, "Application manager created Evaluation Panel -Director approved the Evaluation Panel"), //need to remove
    ...
    FIRST_MEETING_CREATED(60 , "First Meeting create by Application manager"), //done

    FIRST_MEETING_DOC_UPLOADED(61 , "First Meeting completed and documents uploaded"), //done

    FIRST_MEETING_REPORT_UPLOADED(62, "First meeting report, question and evidence uploaded"),

    SECOND_MEETING_CREATED(63 , "Second Meeting create by Application manager"), //done

    SECOND_MEETING_REPORT_UPLOADED(64, "Second meeting report, question and evidence uploaded"),
    ...
    /**------------------------------------------------keeping 10 status for future --------------------------------------------------------*/
    AM_UPLOAD_AGENDA_FORM(99 , "AM or ILEP upload the agenda form"),
    ...
    INSTITUTION_UPDATES_AGENDA_FORM(103 , "Institution updates the agenda form with comments "), //done

    AM_REJECT_SITE_VISIT_DOCUMENT(104,"Am reject the site visit document with comments"),
    ...
    public static ApplicationStatusNew getByCode(Integer code) {
        for (ApplicationStatusNew applicationStatus : values()) {
